          ...
          if (!matrix.isLoggedIn && loggedUser != null) {
            try {
              ...
              if (matrix.canAutoProvision(loggedUser!)) {
                ...
                matrix.autoProvisionUser(appUser: loggedUser!).then((result) {
                  if (result.success) {
                    debugPrint(
                      'Auto-provisioning successful: ${result.message}',
                    );
                  } else {
                    debugPrint(
                      'Auto-provisioning failed: ${result.message}',
                    );
                  }
                }).catchError((e, s) {
                  debugPrintStack(
                ...
                debugPrint(
                  'User cannot be auto-provisioned (missing phone number)',
                );
              }
            } catch (e) {
