...
class OnlineLessonDetailsScreen extends ConsumerStatefulWidget {
  const OnlineLessonDetailsScreen({super.key});

  @override
  ConsumerState<OnlineLessonDetailsScreen> createState() =>
      _OnlineLessonDetailsScreenState();
}

class _OnlineLessonDetailsScreenState
    extends ConsumerState<OnlineLessonDetailsScreen> with AnalyticsScreenMixin {
  @override
  String get screenName => 'OnlineLessonDetailsscreen';
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.laptop, color: context.primary, size: 24.sp),
          SizedBox(width: 12.w),
          Expanded(
            child: Text(
              'حصة أونلاين',
