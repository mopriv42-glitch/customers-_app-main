...
class OnlineBookingSummaryScreen extends StatefulWidget {
  ...
  const OnlineBookingSummaryScreen({
    super.key,
  ...
  @override
  State<OnlineBookingSummaryScreen> createState() =>
      _OnlineBookingSummaryScreenState();
}

class _OnlineBookingSummaryScreenState
    extends State<OnlineBookingSummaryScreen> with AnalyticsScreenMixin {
  
  @override
  String get screenName => 'OnlineBookingSummaryscreen';
