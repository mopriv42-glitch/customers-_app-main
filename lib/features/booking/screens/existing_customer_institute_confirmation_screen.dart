...
class ExistingCustomerInstituteConfirmationScreen extends StatefulWidget {
  ...
  const ExistingCustomerInstituteConfirmationScreen({
    super.key,
  ...
  @override
  State<ExistingCustomerInstituteConfirmationScreen> createState() =>
      _ExistingCustomerInstituteConfirmationScreenState();
}

class _ExistingCustomerInstituteConfirmationScreenState
    extends State<ExistingCustomerInstituteConfirmationScreen> with AnalyticsScreenMixin {
  
  @override
  String get screenName => 'ExistingCustomerInstituteConfirmationscreen';
