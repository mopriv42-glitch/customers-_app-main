...
class _LibrariesScreenState extends ConsumerState<LibrariesScreen> with AnalyticsScreenMixin {
  GovernorateModel? selectedGovernorate;
  RegionModel? selectedRegion;
  
  @override
  String get screenName => 'Librariesscreen';
      ...
      child: Column(
        ...
        children: [
          CircleAvatar(
            ...
            child: Icon(Icons.local_library, color: place.logoColor),
          ),
          SizedBox(height: 8.h),
          Text(place.name,
              maxLines: 1,
