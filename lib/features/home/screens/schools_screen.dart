...
class _SchoolsScreenState extends ConsumerState<SchoolsScreen> with AnalyticsScreenMixin {
  GovernorateModel? selectedGovernorate;
  RegionModel? selectedRegion;
  
  @override
  String get screenName => 'Schoolsscreen';
      ...
      child: Column(
        ...
        children: [
          CircleAvatar(
            ...
            child: Icon(Icons.school, color: place.logoColor),
          ),
          SizedBox(height: 8.h),
          Text(place.name,
              maxLines: 1,
