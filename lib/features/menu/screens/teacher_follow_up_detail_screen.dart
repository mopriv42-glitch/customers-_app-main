...
class TeacherFollowUpDetailScreen extends ConsumerStatefulWidget {
  final String followUpId;

  const TeacherFollowUpDetailScreen({
    super.key,
    required this.followUpId,
  });

  @override
  ConsumerState<TeacherFollowUpDetailScreen> createState() =>
      _TeacherFollowUpDetailScreenState();
}

class _TeacherFollowUpDetailScreenState
    extends ConsumerState<TeacherFollowUpDetailScreen>
    with AnalyticsScreenMixin {
  @override
  String get screenName => 'TeacherFollowUpDetailScreen';
  ...
  Future<void> _loadFollowUp() async {
    ...
    try {
      final followUp = await ref
          .read(ApiProviders.teachersProvider)
          .getTeacherFollowUpDetail(
            context: context,
                        ...
                        return RefreshIndicator(
                          ...
                          child: SizedBox(
                            ...
                            child: Padding(
                              ...
                              child:
                                  _buildFollowUpContent(availableHeight - 24.w),
                            ),
                          ),
                        );
                      },
  ...
  Widget _buildFollowUpContent(double availableHeight) {
    final data = _followUp!;
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  title.isNotEmpty ? title : 'تقرير المتابعة',
                  style: TextStyle(
                    fontSize: 16.sp,
          ...
          SizedBox(height: 4.h),
          Text(
            'متابعة أداء الطالب والتقدم المحرز',
            style: TextStyle(
              fontSize: 12.sp,
              color: context.secondaryText,
            ),
